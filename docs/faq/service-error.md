...
4. 网络问题。
    1. 有的服务在科学上网（或者肉身在国外）的情况下可能无法访问，例如百度翻译
    2. 有的服务恰恰相反，例如谷歌系列的服务可能在国内访问不了
    3. 检查下自己是否开启了全局的科学上网，如果是建议改成 PAC 模式
    4. 如果想为某个服务开启代理，[点此查看各个服务域名](faq/service-proxy.md)
5. 服务商相关的问题。
    1. 百度翻译偶尔会概率性封禁用户的秘钥一天，第二天又好了，原因不是太明确。
    2. [Google Cloud 服务无法使用？](faq/google-service-error.md)
